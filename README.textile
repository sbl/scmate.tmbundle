...
The original has been written by "rfwatson":http://github.com/rfwatson , this is my fork.
...
* @ALT-ESC@<br/>Gives code completion for classes
...
rfwatson via "github":http://github.com/rfwatson 
sbl via "github":http://github.com/sbl 
